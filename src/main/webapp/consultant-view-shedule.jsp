...
<div class="container mt-5">
    <h1><%= request.getAttribute("consultant") %> Consultant Schedule</h1>
    <div class="container mt-5">
        <form action="./ConsultantAddSheduleServlet" method="post" class="styled-form">
            <%
                Map<String, List<String>> schedule = (Map<String, List<String>>) request.getAttribute("consultantSchedule");
            ...
            <div>
                ...
                <div>
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="selectedDate" name="date" value="<%= date %>" readonly>

                    </div>
                    <div class="mb-3" style="margin: 10px;">
                        <label class="form-label">Added Time Slots:</label><br><br>
                        <div id="timeSlotsContainer_<%= date %>">
                            <!-- JavaScript will dynamically add time slot inputs here -->
                            <%
                                int dateSpecificTimeSlotIndex = 0;
                                for (String time : times) {
                            %>
                            <input type="time" class="form-control mb-2 time-slot"
                                   name="timeSlot_<%= date %>_<%= dateSpecificTimeSlotIndex %>"
                                   style="margin:10px; width: 200px" value=<%= time %> readonly>
                            <%
                                    dateSpecificTimeSlotIndex++;
                                }
                            %>
                        </div>
<%--                        <button type="button" class="btn btn-primary" onclick="addTimeSlot('<%= date %>')">Add Time Slot</button>--%>
                    </div><br><br><br>
                </div>
                <%
                    }
