            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                <nav class="menu menu--horatio">
                    <ul class="nav navbar-nav menu__list">
                        <li class="menu__item"><a href="bookappointment.jsp" class="menu__link">Book Appointment</a></li>
                        <li class="menu__item"><a href="view-Consultant.jsp" class="menu__link">View Consultants/JobSeekers</a></li>
                        <li class="menu__item"><a href="recep-details.jsp" class="menu__link">My Details</a></li>
...
<table class="table table-striped table-hover table-bordered" style="background:aliceblue">
    ...
    <%
        ...
        <tr>
                ...
                <td><%=seeker%></td>
                <td><%=status%></td>
            <% if(ap.getGetStatus().equals("valid")){%>
                <td><a href="javascript:void(0);" onclick="confirmAndRemove(<%=id%>)">Cancel</a></td>
            <%}%>
...
<script>
    function confirmAndRemove(id) {
        if (confirm("Are you sure you want to cancel this appointment?")) {
            window.location.href = './BookAppointmentServlet?id=' + id + '&req=remove';
        }
    }
</script>
