            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                <nav class="menu menu--horatio">
                    <ul class="nav navbar-nav menu__list">
                        <li class="menu__item"><a href="view-Consultant.jsp" class="menu__link">View Consultant</a></li>
...
<%--        <strong> <th >Action</th></strong>--%>
    ...
    <%
        ...
        List<User> users = userDao.getJobSeekers();
            ...
            <div class="modal-body modal-spa">
                <div class="login-grids">
                    <div class="login-bottom">
                        ...
                        <form action="./ConsultantJobSeekerRegisterServlet" method="post">
                            <div class="sign-up">
                                <h4>UserName :</h4>
